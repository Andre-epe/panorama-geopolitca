...
tab1, tab3 = st.tabs(["🌐 Mapa PanGeo", "📅 Timeline de Publicações"])
...
with tab3:
    ...
    dados_timeline = dados_timeline.loc[dados_timeline['pais_ou_regiao']=='Região'].copy()
    ...
    dados_timeline['data'] = pd.to_datetime(dados_timeline['data']).dt.strftime('%d/%m/%Y')
    ...
    components.html(timeline_html, height=1200, scrolling=False)